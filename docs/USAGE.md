...
- **Context Length** / **Context Window** / **Context %** / **Context % (usable)** / **Context Bar** - Show current context length, total context window size, used/remaining percentage, usable-window percentage, a progress bar, or the API Monitor Pac-Man context bar.
...
- **Context Bar**: `p` cycle medium/full/Pac-Man/short/short-only progress bar
