...
const FAKE_CLAUDE_CONFIG_DIR = path.resolve('/fake/claude');
const CREDENTIALS_FILE = path.join(FAKE_CLAUDE_CONFIG_DIR, '.credentials.json');
...
describe('getUsageToken', () => {
    beforeEach(() => {
        vi.restoreAllMocks();
        process.env.CLAUDE_CONFIG_DIR = FAKE_CLAUDE_CONFIG_DIR;
        vi.spyOn(claudeSettings, 'getClaudeConfigDir').mockReturnValue(FAKE_CLAUDE_CONFIG_DIR);
