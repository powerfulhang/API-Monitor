...
export const WIDGET_MANIFEST: WidgetManifestEntry[] = [
    ...
    { type: 'mimo-credit', create: () => new widgets.MimoCreditWidget() },
    { type: 'api-credit', create: () => new widgets.ApiCreditWidget() },
    { type: 'api-call-count', create: () => new widgets.ApiCallCountWidget() },
